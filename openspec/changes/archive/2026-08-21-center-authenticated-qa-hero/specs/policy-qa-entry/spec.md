...
- **THEN** the Q&A heading and input are centered in the available content area, the redundant post-input empty-state explanation is absent, and the input’s keyboard submission guidance remains available
